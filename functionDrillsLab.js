...
function faveColorFinder(color) {
  if(color === 'red') {
    faveColor = 'red is a great color';
  } else if(color === 'green') {
    faveColor = 'green is a solid favorite color';
  } else if(color === 'black') {
    faveColor = 'so trendy';
  } else {
    faveColor = 'you need to evaluate your favorite color choice';
  } return faveColor;
}
...
console.log(emailCheck('callen.schultz@gmail'))
...
//CODE HERE
function frogGlutton(goldBudget){
  let frogs = goldBudget / 3;
  return frogs;
}
let totalFrogs = frogGlutton(422);
...
//CODE HERE
function frogGlutton2(goldBudget){
  let frogs = Math.floor(goldBudget / 3);
  return frogs;
}
let totalFrogs2 = frogGlutton2(23);
